...
<head>
	...
	<title>Appointment For Line OA</title>
				...
				<div id="kt_app_header" class="app-header">
					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="app-header-logo d-flex align-items-center ps-lg-2 me-lg-10">
							<!--begin::Mobile toggle-->
							<div class="btn btn-icon btn-color-gray-500 btn-active-color-info w-35px h-35px ms-n2 me-2 d-flex d-lg-none" id="kt_app_sidebar_mobile_toggle">
							...
							<!--begin::Logo image-->
							<a href="/home">
								<img alt="Logo" src="<?php echo base_url();?>theme/dist/assets/media/logos/Book.png" class="h-50px" />
							</a>
							<!--end::Logo image-->
						</div>
						<!--end::Header logo-->
							...
							<div class="app-navbar flex-shrink-0">
								...
								<div class="app-navbar-item ms-3 ms-md-6" id="kt_header_user_menu_toggle">
									...
									<div class="cursor-pointer symbol symbol-30px symbol-md-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										<img class="symbol symbol-circle symbol-30px symbol-md-35px" src="<?php echo base_url();?>profile/<?= session()->get('user_img');?>" alt="user" />
									</div>
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="symbol symbol-50px me-5">
													<img alt="Logo" src="<?php echo base_url();?>profile/<?= session()->get('user_img');?>" />
												</div>
												<!--end::Avatar-->
												<!--begin::Username-->
												<div class="d-flex flex-column">
													...
													<a href="#" class="fw-semibold text-muted text-hover-info fs-7"><?= session()->get('user_email');?></a>
												</div>
												<!--end::Username-->
											</div>
										</div>
										...
										<div class="menu-item px-5">
											<a href="user" class="menu-link px-5">โปรไฟล์</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu separator-->
										<div class="separator my-2"></div>
										...
										<div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
											<a href="#" class="menu-link px-5">
												<span class="menu-title position-relative">โหมด
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px" data-kt-menu="true" data-kt-element="theme-mode-menu">
												...
												<div class="menu-item px-3 my-0">
													<a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="light">
														...
														<span class="menu-title">สว่าง</span>
													</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3 my-0">
													<a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="dark">
														...
														<span class="menu-title">มืด</span>
													</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
										...
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a href="/logout" class="menu-link px-5">ออกจากระบบ</a>
										</div>
										<!--end::Menu item-->
									</div>
								...
								<div class="app-navbar-item d-lg-none ms-2 me-n3" title="Show header menu">
									<div class="btn btn-icon btn-color-gray-500 btn-active-color-info w-35px h-35px" id="kt_app_header_menu_toggle">
