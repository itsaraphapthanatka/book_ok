					...
					<div id="kt_account_settings_profile_details" class="collapse show">
						...
						<form id="kt_account_profile_details_form" class="form">
								...
								<div class="row mb-6">
									...
									<div class="col-lg-4">
										...
										<div class="input-group w-md-300px"
											...
											<button class="btn btn-icon btn-outline btn-active-color-info" type="button" data-kt-dialer-control="decrease">
											...
											<button class="btn btn-icon btn-outline btn-active-color-info" type="button" data-kt-dialer-control="increase">
												<i class="bi bi-plus fs-2"></i>
											</button>
											<!--end::Increase control-->
											<input type="hidden"  id="timedeleyid"  value="<?=$timedeley['id'];?>"/>
										</div>
										<!--end::Dialer--
									</div>
									<!--end::Col-->
							...
							<div class="card-footer d-flex justify-content-end py-6 px-9">
								...
								<button type="button" class="btn btn-info" id="savetimedelay">บันทึก</button>
							</div>
							<!--end::Actions-->
						</form>
						<!--end::Form-->
...
<script>
	$("#savetimedelay").on('click',function(){
		...
		var id = $("#timedeleyid").val();
		$.ajax({
			url: '<?php echo base_url(); ?>saveTimedelay',
			type: 'POST',
			data: {'data': time , 'id': id},
