            ...
            table.DataTable({
                ...
                ajax: {
                    ...
                    data: {
                        ...
                        columnsDef: [
                            'RecordID', 'customer_name',
                            'customer_email', 'customer_mobile',
                            'customer_tag', 'Actions'],
                    },
                },
                columns: [
                    {data: 'RecordID'},
                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
                            console.log(data);
                            return `<a href="#" class="btn btn-light btn-active-light-info btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                                Actions
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-info fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="editCustomer/${data.RecordID}" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
