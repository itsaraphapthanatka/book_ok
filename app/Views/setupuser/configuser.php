                            ...
                            <div class="d-flex flex-wrap align-items-center">
                                ...
                                <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                                    ...
                                    <form id="kt_signin_change_email" class="form" novalidate="novalidate">
                                        ...
                                        <div class="d-flex">
                                            <button id="kt_signin_submit" type="button" class="btn btn-info me-2 px-6">ยืนยัน</button>
                                            <button id="kt_signin_cancel" type="button" class="btn btn-color-gray-400 btn-active-light-info px-6">ยกเลิก</button>
                                        </div>
                                    </form>
                                    <!--end::Form-->
                                </div>
                                ...
                                <div id="kt_signin_email_button" class="ms-auto" hidden>
                                    <button class="btn btn-light btn-active-light-info">แก้ไข</button>
                                </div>
                                <!--end::Action-->
                            </div>
                            <!--end::Email Address-->
                            ...
                            <div class="d-flex flex-wrap align-items-center mb-10">
                                ...
                                <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                                    ...
                                    <form id="kt_signin_change_password" class="form" novalidate="novalidate">
                                        ...
                                        <div class="d-flex">
                                            <button id="kt_password_submit" type="button" class="btn btn-info me-2 px-6">ยืนยัน</button>
                                            <button id="kt_password_cancel" type="button" class="btn btn-color-gray-400 btn-active-light-info px-6">ยกเลิก</button>
                                        </div>
                                    </form>
                                    <!--end::Form-->
                                </div>
